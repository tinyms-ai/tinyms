...
| EP02    | [How we teach computers to understand pictures?+ Three Ways to install TinyMS](https://www.bilibili.com/video/BV18v41187fX) | It uncover the magic of computer vision + three ways to install TinyMS （Ubuntu、Win10、Docker） | [TinyMS Installation For Beginners](https://tinyms.readthedocs.io/zh_CN/latest/quickstart/install.html) | Published | 2020.3.31   |
