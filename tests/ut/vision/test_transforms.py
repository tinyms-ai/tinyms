...
def test_mnist_transform_postprocess():
    ...
    assert label == {'prediction: ': 5, 'score': '0.99964439868927001953'}
...
def test_cifar10_transform_postprocess():
    ...
    assert label == {'prediction: ': 'dog', 'score': '0.99964439868927001953'}
...
def test_imagefolder_transform_postprocess():
    ...
    assert label == {'prediction: ': 'Entoloma霍氏粉褶菌,伞菌目,粉褶菌科,粉褶菌属,主要分布于新西兰北岛和南岛西部,有毒', 'score': '0.99964439868927001953'}
