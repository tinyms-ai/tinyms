...
def parse_args():
    ...
    parser.add_argument('--config_path', type=str, default=None,
                        help='the json file of model config under the dir tinyms/app/object_detection/configs/.')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        detection_image_np = visualize_boxes_on_image(image_np, detection_bbox_data, box_color=(0, 255, 0),
                                                      box_thickness=3, text_font=cv2.FONT_HERSHEY_PLAIN, font_scale=2,
                                                      text_color=(0, 0, 255), font_size=3, show_scores=True)
